...
//		getActionBar().hide();
	...
	public void ZoomToCoverAllMarkers(ArrayList<LatLng> latLngList, GoogleMap googleMap)
    {
	...
	public void DrawRoute(List<RoutePoint> listPoints,String color,String busname,String streetstart,String streetfinish,double totaldistance,double traveltime){
		...
		latLngList.add(markOrigin.getPosition());
		while (I.hasNext()){
		...
		latLngList.add(markDestiny.getPosition());
		ZoomToCoverAllMarkers(latLngList, googlemap);
