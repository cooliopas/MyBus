...
public class FiltersFragment extends BaseFragment implements View.OnClickListener
{
	...
	private AutoCompleteTextView autoCompleteDestiny;
	private ArrayAdapter<String> streetsAdapterO;
	private ArrayAdapter<String> streetsAdapterD;
	...
	public void onCreatedNeckView(View inflatedView)
	{
		...
		//
		String[] streets = getResources().getStringArray(R.array.streetList);
		streetsAdapterO = new ArrayAdapter<String>(activity,android.R.layout.simple_list_item_1,streets);
		streetsAdapterD = new ArrayAdapter<String>(activity,android.R.layout.simple_list_item_1,streets);
		//
		...
		//
		autoCompleteOrigin = (AutoCompleteTextView) view.findViewById(R.id.et_origin);
		autoCompleteDestiny = (AutoCompleteTextView) view.findViewById(R.id.et_destiny);
		// set adapter for the auto complete fields
		autoCompleteOrigin.setAdapter(streetsAdapterO);
		autoCompleteDestiny.setAdapter(streetsAdapterD);
		
		autoCompleteOrigin.setThreshold(3);
		autoCompleteDestiny.setThreshold(3);
        //
