	...
	public View getView(int position, View rowview, ViewGroup viewgroup) {
		...
		if(flagsimpleorcompound == SIMPLE_RESULT){ //Simple view
			...
			if(result.StartBusStopDistanceToOrigin.equals("") == false){
				String dist1 = result.StartBusStopDistanceToOrigin.replaceAll(",", ".");
				String dist2 = result.DestinatioBusStopDistanceToDestination.replaceAll(",", ".");
				double distance = Double.parseDouble(dist1) + Double.parseDouble(dist2);
